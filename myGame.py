...
window.title("Star Wars Game by Vianca Martinez")
...
for _ in range(3):
    ...
    pen.hideturtle()
    pen.goto(0, 250)
    pen.write("Score: 0", False, align = "center", font = ("Times New Roman", 25, "normal"))
    ...
    for chattan in chattans:    
        ...
        for missile in missiles:
            if chattan.distance(missile) < 20:
                ...
                player.score += 10
                pen.clear()
                pen.write("Score: {}".format(player.score), False, align = "center", font = ("Times New Roman", 24, "normal"))
...
window.mainloop()
#This Game is build by Ankur Gajuel